    ...
    "dirinfo" => {
        ...
        "providers/common" => {
            "deps" => [
                ...
                "providers/common/libcommon-lib-provlib.o",
...
unless (caller) {
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '/f/sourcecode/src/ocr/openssl-master/util/perl';
        use OpenSSL::fallback '/f/sourcecode/src/ocr/openssl-master/external/perl/MODULES.txt';
...
use lib '/f/sourcecode/src/ocr/openssl-master/Configurations';
use lib '.';
use platform;
_____
